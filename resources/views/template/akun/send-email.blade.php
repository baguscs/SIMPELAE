															...
															<td class="pad"
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><img
																		...
																		class="big" src="{{ asset('images/animated_header.gif') }}"
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<strong><span
																					style="font-size:38px;">SIMPELAE</span></strong>
																		</p>
																	</div>
																</div>
															</td>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
																			<span style="font-size:16px;">Selamat!!!
																				akun anda telah terdaftar di
																				SIMPELAE</span></p>
																	</div>
																</div>
															</td>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			Silahkan Login dengan E-Mail dan Password
																			dibawah:</p>
																	</div>
																</div>
															</td>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p dir="ltr"
																			style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
																			Nama : <strong>{{ $mailData['name'] }}</strong>
																		</p>
																	</div>
																</div>
															</td>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p dir="ltr"
																			style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
																			E-Mail : <strong>{{ $mailData['email'] }}</strong>
																		</p>
																	</div>
																</div>
															</td>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 12px; mso-line-height-alt: 14.399999999999999px;">
																			Password : <strong>{{ $mailData['password'] }}</strong></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">
																			Anda dapat merubah password ini setelah
																			berhasil login.</p>
																	</div>
																</div>
															</td>
